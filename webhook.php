...
$apiKey = '7927200728:AAHYKHn8FFUi7C5oYEJCtRwlGEB4_wzu_Wk'; // Your Telegram bot API key
...
if ($text === '/start') {
    ...
    $caption = "
    👋 **Welcome to the PDF Adventure!** 🐾🎮

    Get ready for a tail-wagging journey where every paw-tap leads to bigger rewards! Here’s what’s waiting for you:

    ✨ **Play PDF**: Tap the dog bone and watch your balance fetch amazing rewards!
    🐕 **Mine for PUPS**: Collect PDF Tokens with every action your furry friend takes.
    ...
    🐾 **Get Started Now** and take your dog on the ultimate PDF adventure!

    👉 [Join Our Doggo Community](https://t.me/khridoycryptoincome)
    ";
